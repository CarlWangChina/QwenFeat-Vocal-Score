...
if __name__ == "__main__":
    ...
    trainer = QwenAudioTrainer(
        model=model,
        processor=processor,
        train_set=("/home/w-4090/projects/qwenaudio/data/train_gen/train_gen_text_simple.json"),
        val_set=("/home/w-4090/projects/qwenaudio/data/train_gen/test_gen_text_simple.json"),
        device=device,
        local_rank=rank,
    ...
    trainer.lr = 3e-5
    trainer.epochs = 30
    trainer.save_dir = "./ckpts/generator-lora-32-16-textonly-simple-v2-int4"
