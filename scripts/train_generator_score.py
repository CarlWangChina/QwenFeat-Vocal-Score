...
if __name__ == "__main__":
    ...
    trainer = QwenAudioTrainer(
        model=model,
        processor=processor,
        train_set=("/home/w-4090/projects/qwenaudio/data/train_gen/train_score_by_text.json"),
        val_set=("/home/w-4090/projects/qwenaudio/data/train_gen/test_score_by_text.json"),
        device=device,
        local_rank=rank,
