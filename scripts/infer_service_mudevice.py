...
class ProcessorWorker:
    ...
    def _init_processor(self):
        ...
        self.processor = qwenaudio.processor.create_processor(
            "/home/w-4090/projects/qwenaudio/ckpts/score_lora-16-16-pf_score/best_model_epoch/22",
    ...
    def process_audio(self, audio_bytes):
        ...
        with tempfile.NamedTemporaryFile(suffix=".wav", delete=True) as tmp_file:
            ...
            result = {}
            for i in range(4):
                result[qwenaudio.prompts.prompt_mapper_reverse[i]] = \
                    self.processor.generate(data, i)
            return result
...
def process_audio_in_worker(audio_bytes):
    """在工作进程中处理音频"""
    global _worker
    return _worker.process_audio(audio_bytes)
...
async def audio_handler(request):
    ...
    try:
        ...
        result = await loop.run_in_executor(
            executor,
            functools.partial(process_audio_in_worker, audio_bytes)
        )
