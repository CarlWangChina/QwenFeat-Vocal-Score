...
例如`curl -X POST "http://localhost:8080/score_local?get_final_text=1&return_single_score=false"   -F "path=/home/w-4090/cutted_score_audio_separated/446892/344523004.wav"` 将生成总结性文本并返回评分总分，不输出单项的结果  
