...
if __name__ == "__main__":
    ...
    # 初始化模型和处理器
    processor = qwenaudio.processor.ScoreProcessorV3(
        "/home/w-4090/projects/qwenaudio/ckpts/score_lora-16-16-pf_score/best_model_epoch/66",
    ...
    with open("/home/w-4090/projects/qwenaudio/data/train_gen/test_score_by_text.json") as fp:
        ...
        for item in target_comments:
            try:
                ...
                gen_text = processor.generate_text(data, method, simple_model=False)
        ...
        with open("test_score_by_text_v3_有文本分类(已更换)_有参考评语.json", "w") as fp:
            json.dump({
                "results":results,
